...
function program9(depth0,data) {
  ...
  if(stack2 || stack2 === 0) { data.buffer.push(stack2); }
  data.buffer.push("\n            <p class='flag-summary'>");
  hashTypes = {};
  hashContexts = {};
  data.buffer.push(escapeExpression(helpers._triageMustache.call(depth0, "flag.summary", {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data})));
...
function program13(depth0,data) {
  ...
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.i18n),stack1 ? stack1.call(depth0, "admin.groups.can_not_edit_automatic", options) : helperMissing.call(depth0, "i18n", "admin.groups.can_not_edit_automatic", options))));
  data.buffer.push("\n            ");
  return buffer;
  }
...
function program17(depth0,data) {
  ...
  hashContexts = {};
  options = {hash:{},contexts:[depth0],types:["ID"],hashContexts:hashContexts,hashTypes:hashTypes,data:data};
  data.buffer.push(escapeExpression(((stack1 = helpers.i18n),stack1 ? stack1.call(depth0, "admin.groups.about", options) : helperMissing.call(depth0, "i18n", "admin.groups.about", options))));
  data.buffer.push("\n    ");
  return buffer;
  }
